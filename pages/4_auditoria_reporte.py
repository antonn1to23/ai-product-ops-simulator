...
from utils.reporting import generate_sdd_markdown, markdown_to_pdf_bytes, markdown_to_pdf_bytes
...
st.caption("Nota: el PDF usa render básico; el .md es el “source of truth” del entregable.")