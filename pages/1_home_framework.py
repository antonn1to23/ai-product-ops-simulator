...
with st.expander("Definiciones rápidas (para discusión en clase)",
expanded=True):
 st.markdown("""
...
""")
st.markdown("### Radar de madurez (ajusta y discute trade-offs)")
...
with colB:
 ...
 fig = go.Figure(
 data=[go.Scatterpolar(r=values + [values[0]], theta=categories
...
st.info("Objetivo didáctico: antes de “tocar prompts”, forzardecisiones de sistema (roles, flujos, métricas y políticas).")